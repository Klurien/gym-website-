  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        if (storedCred) headers['x-credential'] = storedCred;
      }
    ...
    >
      <div className="absolute top-0 left-0 w-full h-full">
        <div
          ...
          style={{ background: 'radial-gradient(circle, rgba(255,36,66,0.08) 0%, transparent 70%)' }}
        />
        <div
          className="absolute bottom-[-20%] right-[-10%] w-[50%] h-[50%] rounded-full"
          style={{ background: 'radial-gradient(circle, rgba(255,36,66,0.05) 0%, transparent 70%)' }}
        />
      </div>
      ...
      <div className="w-full max-w-md space-y-10 relative z-10">
        <div className="text-center space-y-3">
          ...
          <div>
            ...
            <h1 className="t-display" style={{ color: 'var(--red)' }}>GYM</h1>
          </div>
