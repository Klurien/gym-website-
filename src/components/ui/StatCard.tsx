...
export default function StatCard({
  ...
  return (
    <div
      className="rounded-[16px] p-5 text-center relative overflow-hidden"
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="font-anton text-3xl text-white" style={{ lineHeight: 1 }}>
          {prefix}
          {display}
          {suffix}
        </p>
        <p className="t-label mt-1" style={{ color: 'var(--text-3)' }}>
          {label}
        </p>
      </div>
    </div>
